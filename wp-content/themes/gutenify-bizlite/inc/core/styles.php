 ...
 * @return void
 */
function gutenify_bizlite_get_color_value( $value ) {
...
function gutenify_bizlite_global_styles_vars() {
	...
	if ( ! empty( $core_button_styles['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--color--background: ' . gutenify_bizlite_get_color_value( esc_attr( $core_button_styles['color']['background'] ) ) . ';';
	}

	if ( ! empty( $core_button_styles['color']['text'] ) ) {
		// var(--wp--preset--color--vivid-red)
		$element_css_styles .= '--wp--custom--core-button--color: ' . gutenify_bizlite_get_color_value( esc_attr( $core_button_styles['color']['text'] ) ) . ';';
	}
	...
	if ( ! empty( $core_button_styles[':hover']['color']['background'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--hover--color--background: ' . gutenify_bizlite_get_color_value( esc_attr( $core_button_styles[':hover']['color']['background'] ) ) . ';';
	}

	if ( ! empty( $core_button_styles[':hover']['color']['text'] ) ) {
		$element_css_styles .= '--wp--custom--core-button--hover--color: ' . gutenify_bizlite_get_color_value( esc_attr( $core_button_styles[':hover']['color']['text'] ) ) . ';';
	}
...
add_action( 'wp_enqueue_scripts', 'gutenify_bizlite_global_styles_vars', 100 );
