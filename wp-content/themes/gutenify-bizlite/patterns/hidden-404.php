<?php
 /**
  * Title: Hidden 404
  * Slug: gutenify-bizlite/hidden-404
...
<?php echo esc_html__( '4', 'gutenify-bizlite' ); ?><mark style="background-color: rgba(0, 0, 0, 0); color: #01dacc" class="has-inline-color"><?php echo esc_html__( '0', 'gutenify-bizlite' ); ?></mark><?php echo esc_html__( '4', 'gutenify-bizlite' ); ?>
		</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'This page could not be found. Maybe try a search?', 'gutenify-bizlite' ); ?> </p>
<!-- /wp:paragraph -->
